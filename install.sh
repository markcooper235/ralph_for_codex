...
copy_file "$RUNTIME_SOURCE_DIR/core/cli/codex-exec.mjs" "$DEST_DIR_REL/core/cli/codex-exec.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/cli/pi-exec.mjs" "$DEST_DIR_REL/core/cli/pi-exec.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/cli/verification.mjs" "$DEST_DIR_REL/core/cli/verification.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/cli/update-story.mjs" "$DEST_DIR_REL/core/cli/update-story.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/cli/execution-plan.mjs" "$DEST_DIR_REL/core/cli/execution-plan.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/cli/execution-context.mjs" "$DEST_DIR_REL/core/cli/execution-context.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/cli/dependency-handoff.mjs" "$DEST_DIR_REL/core/cli/dependency-handoff.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/cli/execution-files.mjs" "$DEST_DIR_REL/core/cli/execution-files.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/cli/project-commands.mjs" "$DEST_DIR_REL/core/cli/project-commands.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/cli/story-runtime.mjs" "$DEST_DIR_REL/core/cli/story-runtime.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/cli/story-query.mjs" "$DEST_DIR_REL/core/cli/story-query.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/cli/run-check.mjs" "$DEST_DIR_REL/core/cli/run-check.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/cli/run-task-checks.mjs" "$DEST_DIR_REL/core/cli/run-task-checks.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/cli/validate-story-container.mjs" "$DEST_DIR_REL/core/cli/validate-story-container.mjs"
...
copy_file "$RUNTIME_SOURCE_DIR/core/repositories/story-repository.mjs" "$DEST_DIR_REL/core/repositories/story-repository.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/application/verification.mjs" "$DEST_DIR_REL/core/application/verification.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/application/check-runner.mjs" "$DEST_DIR_REL/core/application/check-runner.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/application/task-check-runner.mjs" "$DEST_DIR_REL/core/application/task-check-runner.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/application/story-container.mjs" "$DEST_DIR_REL/core/application/story-container.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/application/update-story.mjs" "$DEST_DIR_REL/core/application/update-story.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/application/execution-plan.mjs" "$DEST_DIR_REL/core/application/execution-plan.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/application/execution-context.mjs" "$DEST_DIR_REL/core/application/execution-context.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/application/dependency-handoff.mjs" "$DEST_DIR_REL/core/application/dependency-handoff.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/application/execution-files.mjs" "$DEST_DIR_REL/core/application/execution-files.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/application/project-commands.mjs" "$DEST_DIR_REL/core/application/project-commands.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/application/story-runtime.mjs" "$DEST_DIR_REL/core/application/story-runtime.mjs"
...
copy_file "$RUNTIME_SOURCE_DIR/core/adapters/process-runner.mjs" "$DEST_DIR_REL/core/adapters/process-runner.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/adapters/codex-process.mjs" "$DEST_DIR_REL/core/adapters/codex-process.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/adapters/pi-process.mjs" "$DEST_DIR_REL/core/adapters/pi-process.mjs"
copy_file "$RUNTIME_SOURCE_DIR/core/ports/harness.mjs" "$DEST_DIR_REL/core/ports/harness.mjs"
