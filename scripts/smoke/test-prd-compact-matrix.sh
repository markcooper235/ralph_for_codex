...
## Scope
- Keep the change tightly scoped to the explicitly named source and proof files.

## Out of Scope
- Any broad refactor or cross-cutting workflow change.

## Execution Model
- Start with the first slice in the exact source file path, keep support scope explicit, and verify before widening.
- Keep supporting scope limited to the named proof files and verify through typecheck, lint, and tests.
